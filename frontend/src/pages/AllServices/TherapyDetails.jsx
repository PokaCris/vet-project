    ...
    return (
        <>
            ...
            <Container className='service-details-container'>
                <Row className='mb-5'>
                    <Col>
                        <h1 className='service-page-title mb-4'>Терапия</h1>
                        ...
                        <div className='mb-5'>
                            <h2 className='service-section-title mb-3'>Прием ветеринарного терапевта</h2>
                            <p className='service-text mb-4'>
                            ...
                            <div className='mt-4'>
                                <h4 className='list-title mb-3'>Что включает ветеринарный осмотр:</h4>
                                <Row>
                                    <Col md={6}>
                        ...
                        <div className='mb-5'>
                            <h2 className='service-section-title mb-3'>Консультации специалистов</h2>
                            <p className='service-text mb-4'>
                            ...
                            <div className='mt-4'>
                                <h4 className='list-title mb-3'>Когда нужна консультация узкого специалиста:</h4>
                                <Row>
                        ...
                        <div className='p-4 bg-light rounded'>
                            <h3 className='summary-title mb-3'>Наш подход к терапии</h3>
                            <p className='mb-0'>
