    ...
    return (
        <>
            ...
            <Container className='service-details-container'>
                <Row className='mb-5'>
                    <Col>
                        <h1 className='service-page-title mb-4'>Вакцинация и анестезия</h1>

                        <div className='mb-5'>
                            <h2 className='service-section-title mb-3'>Вакцинация животных</h2>
                            ...
                            <div className='mt-4'>
                                <h4 className='list-title mb-3'>Преимущества вакцинации:</h4>
                        ...
                        <div className='mb-5'>
                            <h2 className='service-section-title mb-3'>Как проходит вакцинация</h2>
                            <Row>
                                <Col md={6}>
                                    <div className='p-3'>
                        ...
                        <div className='mb-5'>
                            <h2 className='service-section-title mb-3'>Анестезия в ветеринарии</h2>
                            <p className='service-text'>
                            ...
                            <div className='mt-4'>
                                <h4 className='list-title mb-3'>Виды анестезии:</h4>
                                <Row>
                        ...
                        <div className='p-4 bg-light rounded'>
                            <h3 className='summary-title mb-3'>Безопасность в VetClinic</h3>
                            <p className='mb-0'>
